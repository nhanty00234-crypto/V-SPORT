...
| Modify | `src/main/java/org/example/controller/manager/QuanLySanManagerServlet.java` | Hook manager san (`/manager/quan-ly-san`; admin QuanLySanServlet đã xóa) |
...
- Modify: `src/main/java/org/example/controller/manager/QuanLySanManagerServlet.java` (audit hooks for Manager sân; admin QuanLySanServlet đã xóa)
...
- [ ] **Step 3: Hook `QuanLySanManagerServlet.java` (Manager sân — `/manager/quan-ly-san`)**

Mở `src/main/java/org/example/controller/manager/QuanLySanManagerServlet.java`. Admin `QuanLySanServlet` đã bị xóa — không hook servlet cũ.
