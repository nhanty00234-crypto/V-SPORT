...
export const metadata = { title: 'Thùng rác | V-SPORT' }
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="p-6 text-center text-slate-400 py-16">
        ...
        <a href={`${BASE}/manager/thung-rac`} className="mt-4 inline-block text-indigo-600 text-sm hover:underline">
