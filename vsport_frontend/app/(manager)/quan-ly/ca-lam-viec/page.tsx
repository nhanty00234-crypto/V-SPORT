    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Lập lịch và quản lý ca trực của nhân viên.</p>
        </div>
        <a href={`${BASE}/manager/ca-lam-viec`}
      ...
      <div className="p-6 text-center text-slate-400 py-16">
        ...
        <p className="font-medium">Giao diện quản lý ca làm việc.</p>
        <a href={`${BASE}/manager/ca-lam-viec`} className="mt-4 inline-block text-indigo-600 text-sm hover:underline">
