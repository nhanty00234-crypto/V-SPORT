    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Quản lý chương trình khuyến mãi toàn hệ thống.</p>
        </div>
        <a href={`${BASE}/admin/khuyen-mai`}
      ...
      <div className="p-6 text-center text-slate-400 py-16">
        ...
        <p className="font-medium">Giao diện Khuyến mãi.</p>
        <a href={`${BASE}/admin/khuyen-mai`} className="mt-4 inline-block text-blue-600 text-sm hover:underline">
