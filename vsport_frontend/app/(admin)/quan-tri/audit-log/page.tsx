    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Nhật ký toàn bộ thao tác trên hệ thống.</p>
        </div>
        <a href={`${BASE}/admin/audit-log`}
      ...
      <div className="p-6 text-center text-slate-400 py-16">
        ...
        <a href={`${BASE}/admin/audit-log`} className="mt-4 inline-block text-blue-600 text-sm hover:underline">
