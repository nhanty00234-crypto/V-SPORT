            ...
            <div class="p-6 md:p-8">
                ...
                <form id="booking-form" action="${pageContext.request.contextPath}/customer/dat-san" method="post" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="date" name="ngayDat" id="ngayDat" required class="form-input" onchange="checkScheduleAndPrice()">
                    </div>
    ...
    <script>
        ...
        function renderCourts() {
            ...
            filteredCourts.forEach(c => {
                ...
                const branch = branches[c.branchId] || { name: "Cơ Sở chung", address: "" };
