...
<head>
    ...
    <style>
        ...
        .acc-card { background: #ffffff; border: 1px solid #e2e8f0; border-radius: 14px; }
        .acc-input {
        ...
        .gk-tab.active { background: #059669; color: #fff; }
...
<main class="flex-grow pt-24 pb-20">
    <div class="max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Page header -->
        <div class="mb-7">
            <h1 class="text-2xl sm:text-[28px] font-extrabold text-slate-900 tracking-tight flex items-center gap-2.5">
                <span class="material-symbols-outlined text-emerald-600 text-[26px]">groups</span>
                Ghép kèo
            </h1>
            <p class="text-sm text-slate-500 mt-1.5 max-w-2xl">Tìm bạn chơi, tạo kèo giao lưu và ghép đối thủ phù hợp trình độ. Điểm uy tín của bạn giúp hệ thống ghép người chơi an toàn hơn cho mọi người.</p>
        </div>

        <!-- Tabs -->
        <div class="acc-card p-2 mb-6 flex items-center gap-1 overflow-x-auto">
        ...
        <div class="gk-panel" id="panel-dang-mo">
            <div class="acc-card p-5 mb-5 bg-emerald-50/60 border-emerald-100 flex items-start gap-3">
                <span class="material-symbols-outlined text-emerald-600 text-[20px] mt-0.5">info</span>
                <p class="text-xs text-emerald-800 leading-relaxed">Chức năng ghép kèo đang được phát triển. Điểm uy tín hiện tại sẽ giúp hệ thống ghép người chơi an toàn hơn.</p>
            </div>

            <p class="text-[11px] font-extrabold text-slate-400 uppercase tracking-wide mb-3">Ví dụ minh họa giao diện thẻ kèo</p>
            <div class="acc-card p-5 opacity-70 max-w-md">
                ...
                <p class="text-sm font-bold text-slate-800 mb-1">Sân V-SPORT Cầu Giấy &middot; Sân số 2</p>
                <p class="text-xs text-slate-500 mb-3">Thứ Bảy, 20:00 &ndash; 21:30 &middot; Cần thêm 3 người &middot; Trình độ: Trung bình</p>
                <button type="button" disabled class="btn-primary w-full opacity-60 cursor-not-allowed">Tham gia (sắp ra mắt)</button>
            </div>
            <div class="text-center py-14">
                <span class="material-symbols-outlined text-[40px] text-slate-200 block mb-3">event_available</span>
                <p class="text-sm text-slate-400 font-semibold">Hiện chưa có kèo nào đang mở.</p>
            </div>
        </div>

        <!-- Panel: Tạo kèo -->
        <div class="gk-panel" id="panel-tao-keo">
            <div class="acc-card p-6 max-w-2xl">
                <h3 class="text-sm font-extrabold text-slate-900 mb-5">Thông tin kèo</h3>
        ...
        <div class="gk-panel" id="panel-tim-doi-thu">
            <div class="acc-card p-6 max-w-2xl">
                <h3 class="text-sm font-extrabold text-slate-900 mb-2">Tìm đối thủ gần nhất</h3>
                <p class="text-xs text-slate-500 mb-5 leading-relaxed">Chức năng tìm đối thủ gần nhất sẽ dùng vị trí, môn thể thao, trình độ và điểm uy tín để đề xuất người chơi phù hợp.</p>
