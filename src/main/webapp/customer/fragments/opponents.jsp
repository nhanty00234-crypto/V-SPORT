...
<div class="breadcrumb">
    <a href="${pageContext.request.contextPath}/">Trang chủ</a> / <a href="${pageContext.request.contextPath}/customer/tai-khoan">Tài khoản</a> / <span>Opponents</span>
</div>
<h1 class="page-title">Opponents</h1>
