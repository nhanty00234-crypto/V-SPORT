  ...
  <section class="w-full lg:w-[360px] bg-white border border-zinc-200 rounded-2xl flex flex-col overflow-hidden shrink-0 shadow-sm" data-aos="fade-right">
    <div class="p-4 border-b border-zinc-200 flex items-center justify-between gap-3">
      <div class="relative flex-1">
        ...
        <input type="search" id="searchTickets" autocomplete="off" oninput="filterTickets(this.value)" placeholder="Tìm kiếm yêu cầu..." class="w-full h-9 pl-9 pr-3 rounded-lg border border-zinc-200 text-xs text-zinc-800 focus:border-blue-500 focus:outline-none transition-colors">
      </div>
