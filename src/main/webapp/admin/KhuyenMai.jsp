...
<jsp:include page="/admin/common/header.jsp">
  <jsp:param name="pageTitle" value="Khuyến mãi"/>
</jsp:include>
...
<%-- altInput:false để JS đọc/ghi .value vẫn hoạt động; lịch popup hiển thị tiếng Việt --%>
<script>document.addEventListener('DOMContentLoaded',function(){ vsDatePicker('#promoStart,#promoEnd',{altInput:false}); });</script>
</body>
</html>
