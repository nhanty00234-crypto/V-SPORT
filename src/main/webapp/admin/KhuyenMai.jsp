  ...
  <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 animate-fade-up" style="animation-delay: 200ms;">
    <div class="flex items-center gap-2 flex-wrap">
      ...
      <div class="relative">
        ...
        <input id="searchPromo" type="text" placeholder="Tìm mã, tên khuyến mãi..." class="h-9 pl-8 pr-3 rounded-lg border border-zinc-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 w-[220px]">
      </div>
    </div>
