...
<%-- altInput:false để JS đọc .value vẫn hoạt động; lịch popup hiển thị tiếng Việt --%>
<script>document.addEventListener('DOMContentLoaded',function(){ vsDatePicker('#filterDate',{altInput:false}); });</script>
</body>
</html>
