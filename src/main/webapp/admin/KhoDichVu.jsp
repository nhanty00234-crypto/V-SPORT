...
<jsp:include page="/admin/common/header.jsp">
  <jsp:param name="pageTitle" value="Kho hàng &amp; Dịch vụ"/>
</jsp:include>
...
<script>document.addEventListener('DOMContentLoaded',function(){ vsDatePicker('#bookingDate',{defaultDate:'today'}); });</script>
</body>
</html>
