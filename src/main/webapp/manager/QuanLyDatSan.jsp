...
<head>
  ...
  <style>
    ...
    .card { background:#fff; border:1px solid #ede9fe; border-radius:16px; transition:box-shadow .2s, transform .2s; }
    .card-hover:hover { box-shadow:0 8px 24px -8px rgba(109, 40, 217, 0.12); transform:translateY(-1px); }
...
<body class="bg-zinc-50 text-zinc-900 min-h-screen">
  ...
  <header class="h-[64px] fixed top-0 right-0 left-0 lg:left-[248px] bg-white/80 backdrop-blur-lg border-b border-purple-100 z-20 flex items-center justify-between px-4 lg:px-6">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-sm font-bold text-purple-900 tracking-tight">Duyệt yêu cầu đặt sân</h1>
    ...
    <div class="w-full max-w-md bg-white rounded-2xl p-6 shadow-2xl animation-pop mx-4">
      ...
      <form action="${pageContext.request.contextPath}/manager/dat-san" method="POST" class="mt-4" autocomplete="off">
        ...
        <div>
          ...
          <textarea id="rejectReason" name="reason" rows="3" required placeholder="Nhập lý do từ chối đơn đặt sân..." 
