...
<div id="profileEmailOtpModal" class="hidden fixed inset-0 z-[85] flex items-center justify-center p-4">
  ...
  <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-[420px] z-10 border border-zinc-200 modal-animate-scale">
    ...
    <div class="px-6 py-5">
      ...
      <input id="profileEmailOtpInput" type="text" maxlength="6" inputmode="numeric" placeholder="••••••" class="mt-4 w-full h-12 rounded-lg border border-zinc-200 text-center text-xl font-black tracking-[0.35em] focus:border-purple-700 focus:outline-none">
