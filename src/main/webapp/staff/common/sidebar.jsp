...
<aside id="sidebar"
  ...
  <nav class="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-0.5" id="sidebarNav">
    ...
    <c:set var="grpCaNhan"   value="${uri.contains('/staff/ca-lam') || uri.contains('/CaLamViec.jsp') || uri.contains('/yeu-cau-nghi') || uri.contains('/yeuCauNghi_') || uri.contains('/staff/luong') || uri.contains('/LuongCuaToi')}" />
    ...
    <div class="nav-group-wrap">
      ...
      <div class="nav-group-children ${grpCaNhan ? 'group-open' : ''}">
        ...
        <a href="${pageContext.request.contextPath}/staff/luong"
          class="nav-link ${uri.contains('/staff/luong') || uri.contains('/LuongCuaToi') ? 'active' : ''}">
